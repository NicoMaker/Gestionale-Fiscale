...
function seedData(db) {
  ...
  tipologie.forEach((t) =>
    db.run(`INSERT INTO tipologie_cliente (codice,nome,descrizione,colore) VALUES (?,?,?,?)`, [t.codice, t.nome, t.descrizione, t.colore])
  );
  ...
  sottotipologie.forEach((s) =>
    db.run(`INSERT INTO sottotipologie (id_tipologia,codice,nome,is_separator,ordine) VALUES (?,?,?,?,?)`, [s.it, s.c, s.n, s.sep, s.ord])
  );
